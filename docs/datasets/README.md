...
never bus, station, device, contingency or constraint names, or file names.
...
`measure_identity.py`) and the reports they write under `data/reports/`.
...
## Validation                what scripts/validate_parsers.py checks
## Open questions
```
